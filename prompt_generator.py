...
for topic, sub_topics in topics.items():
    for sub_topic in sub_topics:
        prompt = {
            "topic": topic,
            "sub_topic": sub_topic,
            "question_prompt": f"Generate 10 questions about {sub_topic} with their difficulty level. List the question followed by its difficulty level (e.g., Easy, Medium, Hard). only list the question and difficulty level. in json"
        }
        output.append(prompt)

# Save to JSON file
output_file_path = r"Generated_Prompts1.json"
